...
export const Phase2 = () => {
  ...
  return (
    <div className="roadMap-section md:flex justify-center items-center gap-10 relative">
      <div className="roadMap-section-para animate-left">
      ...
      <div
        className="map-img1 md:w-[60%] md:rounded-r-lg rounded-lg overflow-hidden animate-right"
      ...
      >
        <img
          src={phase2}
          alt="phase2-ai"
          className={` img1 overflow-hidden ${hovered ? "hover-effect" : ""}`}
        />
